...
import standard1 from '../roomimage/oceanroom1.jpg'
import standard2 from '../roomimage/oceanroom2.jpg'
import standard3 from '../roomimage/oceanroom3.avif'
import standard4 from '../roomimage/oceanroom4.webp'
import standard5 from '../roomimage/oceanroom5.jpg'
import couple1 from '../roomimage/oceanroom6.jpg'
import couple2 from '../roomimage/oceanroom7.jpg'
import couple3 from '../roomimage/oceanroom8.jpg'
import couple4 from '../roomimage/oceanroom9.jpg'
import couple5 from '../roomimage/oceanroom10.jpg'
import premium1 from '../roomimage/oceanroom11.jpg'
import premium2 from '../roomimage/oceanroom12.jpg'
import premium3 from '../roomimage/oceanroom13.jpg'
import premium4 from '../roomimage/oceanroom14.webp'
import premium5 from '../roomimage/oceanroom15.jpg'
 ...
 <div className="card w-82 bg-base-100 shadow-xl">
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
      <nav>
        <Link to ='/hotel/ocean101/standard'>
...
<div className='room3'>
 <div className="card w-82 bg-base-100 shadow-xl">
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
    <nav>
    <Link to='/hotel/ocean101/standard3'>
    <button type="button" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 
