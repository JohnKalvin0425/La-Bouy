...
import h1 from '../roomimage/hillroom1.jpg';
import h2 from '../roomimage/hillroom2.jpg';
import h3 from '../roomimage/hillroom3.jpg';
import h4 from '../roomimage/hillroom4.jpg';
import h5 from '../roomimage/hillroom5.jpg';
import h6 from '../roomimage/hillroom6.webp';
import h7 from '../roomimage/hillroom7.jpg';
...
import standard1 from '../roomimage/hillroom1.jpg'
import standard2 from '../roomimage/hillroom2.jpg'
import standard3 from '../roomimage/hillroom3.jpg'
import standard4 from '../roomimage/hillroom4.jpg'
import standard5 from '../roomimage/hillroom5.jpg'
import couple1 from '../roomimage/hillroom6.webp'
import couple2 from '../roomimage/hillroom7.jpg'
import couple3 from '../roomimage/hillroom8.jpg'
import couple4 from '../roomimage/hillroom9.jpg'
import couple5 from '../roomimage/hillroom10.jpg'
import premium1 from '../roomimage/hillroom11.avif'
import premium2 from '../roomimage/hillroom12.webp'
import premium3 from '../roomimage/hillroom13.jpg'
import premium4 from '../roomimage/hillroom14.jpg'
import premium5 from '../roomimage/hillroom15.webp'
...
<div className='grid grid-cols-1'>
    <h1 className='text-3xl font-semibold mb-1'>Hillside Resort</h1>
    <div className='flex'>
 ...
 <div className="card w-82 bg-base-100 shadow-xl">
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
      <nav>
        <Link to ='/hotel/hillside/standard'>
...
<div className='room3'>
 <div className="card w-82 bg-base-100 shadow-xl">
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
    <nav>
    <Link to='/hotel/hillside/premium'>
    <button type="button" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 
...
<div className='md:max-w-[1400px] max-w-[600px]  m-auto w-full h-full bg-white p-3 rounded-xl mt-12' >
    ...
    <div className=' grid sm:grid-cols-1 grid-row-2 lg:grid-cols-3 gap-5 ml-2'>
        ...
        <div className='col-span-2'>
            <h1 className='text-xl font-semibold mb-2 '>Hillside Resort</h1>
